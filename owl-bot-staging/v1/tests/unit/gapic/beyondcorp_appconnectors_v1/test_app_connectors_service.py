...
from google.cloud.beyondcorp_appconnectors_v1.services.app_connectors_service import AppConnectorsServiceAsyncClient
...
from google.cloud.beyondcorp_appconnectors_v1.services.app_connectors_service import transports
...
@pytest.mark.parametrize("client_class", [
    AppConnectorsServiceClient, AppConnectorsServiceAsyncClient
])
@mock.patch.object(AppConnectorsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppConnectorsServiceClient))
@mock.patch.object(AppConnectorsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppConnectorsServiceAsyncClient))
...
def test_list_app_connectors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, app_connectors_service.AppConnector)
                   for i in results)
...
def test_get_app_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_app_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_app_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_app_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_app_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_app_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_app_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_app_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_report_status(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.report_status),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_app_connectors_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = app_connectors_service.ListAppConnectorsResponse.pb(return_value)
...
def test_list_app_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_list_app_connectors") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_list_app_connectors") as pre:
...
def test_get_app_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_get_app_connector") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_get_app_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_app_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_create_app_connector") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_create_app_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_app_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_update_app_connector") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_update_app_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_app_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_delete_app_connector") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_delete_app_connector") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_report_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "post_report_status") as post, \
         mock.patch.object(transports.AppConnectorsServiceRestInterceptor, "pre_report_status") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AppConnectorsServiceGrpcTransport, transports.AppConnectorsServiceGrpcAsyncIOTransport])
def test_app_connectors_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
